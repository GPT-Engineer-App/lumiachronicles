...
**Project**: lumiachronicles 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a financial blog with the name lumiajournals with green and cream theme like vanguard 
...
```sh
git clone https://github.com/GPT-Engineer-App/lumiachronicles.git
cd lumiachronicles
npm i
